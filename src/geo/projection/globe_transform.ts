...
export class GlobeTransform extends Transform implements ITransform {
    ...
    private _updateAnimation() {
        ...
        if (oldGlobeness !== this._globeness) {
            this.setCenterZoom(
                ...
                lerp(this._mercatorTransform.zoom, this.zoom, this._globeness)
            );
        }
    }
    ...
    override setLocationAtPoint(lnglat: LngLat, point: Point): void {
        ...
        this.setCenterZoom(new LngLat(newLng, clamp(newLat, -90, 90)), this.zoom + getZoomAdjustment(this, oldLat, this.center.lat));
    }
